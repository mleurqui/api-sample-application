...
@RestController
@RequestMapping("/api/api-sample-application-kafka")
public class ApiSampleApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ApiSampleApplicationKafkaResource.class);
    ...
    public ApiSampleApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
